...
export const TEAM_MEMBERS: ITEAM_MEMBER[] = [
  ...
  {
    name: 'Jack',
    image: '/assets/team-member-headshots/headshot - Jack.jpg',
    institution: INSTITUTIONS.CARLETON_UNIVERSITY,
    role: ROLE.COLEAD,
    yearStanding: '3rd',
    programName: 'Aerospace Engineering - Minor in Math',
    email: ROLE_EMAIL_MAP[ROLE.COLEAD],
    linkedin: 'https://www.linkedin.com/in/jacktremblaylessard/',
    github: '',
    website: '',
    instagram: '',
  },
  ...
  {
    name: 'Anthony Hoang',
    image: '/assets/team-member-headshots/IMG_20240728_192528_453 - Anthony Hoang.jpg',
    institution: INSTITUTIONS.CARLETON_UNIVERSITY,
    role: ROLE.LOGISTICS_TEAM,
    yearStanding: '2nd',
    programName: 'Aerospace Engineering ',
    email: ROLE_EMAIL_MAP[ROLE.LOGISTICS_TEAM],
    linkedin: 'https://www.linkedin.com/in/anthony-hoang-1a238a336?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app',
    github: '',
    website: '',
    instagram: '',
  },
  {
    name: 'Abby Wilson ',
    image: '/assets/team-member-headshots/IMG_3243 - Abby Wilson.jpeg',
    institution: INSTITUTIONS.UNIVERSITY_OF_OTTAWA,
    role: ROLE.PATRONAGE_TEAM_MEMBER,
    yearStanding: '3rd',
    programName: 'Multidisciplinary Design ',
    email: ROLE_EMAIL_MAP[ROLE.PATRONAGE_TEAM_MEMBER],
    linkedin: 'https://www.linkedin.com/in/abby-c-wilson?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
    github: '',
    website: '',
    instagram: '',
  },
  {
    name: 'Caroline Twelves',
    image: '/assets/team-member-headshots/IMG_0282 - Caroline Twelves.jpeg',
    institution: INSTITUTIONS.CARLETON_UNIVERSITY,
    role: ROLE.TREASURER,
    yearStanding: '3rd',
    programName: 'Computer Systems Engineering',
    email: ROLE_EMAIL_MAP[ROLE.TREASURER],
    linkedin: 'https://www.linkedin.com/in/carolinetwelves?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
    github: '',
    website: '',
    instagram: '',
  },
  {
    name: 'Xavier',
    image: '/assets/team-member-headshots/1666804194060 - Lord “Lord_Xaebryhs” Xaebryhs.jpg',
    institution: INSTITUTIONS.UNIVERSITY_OF_OTTAWA,
    ...
    github: 'https://github.com/Egzavyer',
    website: '',
    instagram: '',
  },
  {
    name: 'Jad Mghabghab',
    image: '/assets/team-member-headshots/IMG_4377 - Jad Mghabghab.jpeg',
    institution: INSTITUTIONS.UNIVERSITY_OF_OTTAWA,
    role: ROLE.IEEE_CHAIR,
    yearStanding: '5th',
    programName: 'Computer Engineering',
    email: '',
    linkedin: 'https://www.linkedin.com/in/jadmgh/',
    github: '',
    website: '',
    instagram: '',
  },
  {
    name: 'Matt',
    image: '/assets/team-member-headshots/Bekkers_Matthe - Matthé Bekkers.jpg',
    institution: INSTITUTIONS.CARLETON_UNIVERSITY,
    role: ROLE.CARLETON_REP,
    yearStanding: '3rd',
    programName: 'Computer Systems Engineering',
    email: '',
    linkedin: 'https://www.linkedin.com/in/matth%C3%A9-bekkers/',
    github: 'https://github.com/matt-bekkers',
    website: '',
    instagram: '',
  },
  {
    name: 'Winny Kameni',
    image: '/assets/team-member-headshots/Winny - Winny Kameni.jpg',
    institution: INSTITUTIONS.CARLETON_UNIVERSITY,
    role: ROLE.AC_REP,
    yearStanding: '4th',
    programName: 'Information Technology - Major in Optical Systems and Sensors',
    email: '',
    linkedin: 'https://www.linkedin.com/in/winny-kameni-194349185/',
    github: 'https://www.linkedin.com/in/winny-kameni-194349185/',
    website: 'https://winny-portfolio-1.vercel.app/',
    instagram: '',
  },
  {
    name: 'Emmanuel Eyito',
    image: '/assets/team-member-headshots/DSCF7928 - Emmanuel Eyito.jpg',
  ...
  {
    name: 'Gray Joslin',
    image: '/assets/team-member-headshots/IMG_7920 - Gray.jpeg',
    institution: INSTITUTIONS.CARLETON_UNIVERSITY,
  ...
  {
    name: 'Saim Hashmi',
    image: '/assets/team-member-headshots/IMG_5282 - Saim Hashmi.jpeg',
    institution: INSTITUTIONS.CARLETON_UNIVERSITY,
