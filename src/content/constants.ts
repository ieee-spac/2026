...
export enum ROLE {
  ...
  TREASURER = 'Treasurer',
  CU_CHAIR_TREASURER = 'CU Chair / Treasurer',
  UOTTAWA_CHAIR = 'uOttawa Chair',
  ...
  LOGISTICS_VOLUNTEER = 'Logistics Volunteer',
  UOTTAWA_VICE_CHAIR = 'uOttawa Vice-Chair',
...
export const ROLE_EMAIL_MAP: Record<ROLE, string> = {
  ...
  [ROLE.LOGISTICS_VOLUNTEER]: 'logistics@ieeespac.ca',
